...
class Sprite{
	constructor({position, imageSrc, scale = 1, framesMax = 1, offset = {x: 0, y: 0} }){
		//each instance of position will eb equal to current position
		...
		this.framesElapsed = 0 //frames elapsed in animation
		this.framesHold = 5 // lower = faster
		this.offset = offset
		}
...
class Fighter extends Sprite{
	...
	switchSprite(sprite){
		...
		//as soon as frames done basically
